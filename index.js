        ...
        app.put("/update-experiences/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    ...
                    experienceImage: sectionExperience.experienceImage,
 ...
 * **/
        ...
        app.put("/update-worksec/:id", async (req, res) => {
            ...
            const updatedDoc = {
                $set: {
                    processImage: workSection.processImage,
                    processText: workSection.processText,
                    processHeading: workSection.processHeading,
                    processDetails: workSection.processDetails,
                    pointOne: workSection.pointOne,
                    pointOneDetails: workSection.pointOneDetails,
                    pointTwo: workSection.pointTwo,
                    pointTwoDetails: workSection.pointTwoDetails,
...
app.listen(port, () => {
    console.log('Good Job, SEO-9  Server is Live Now', port);
});